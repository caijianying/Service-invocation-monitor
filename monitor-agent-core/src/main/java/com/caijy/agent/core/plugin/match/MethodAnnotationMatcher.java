...
public class MethodAnnotationMatcher<T extends MethodDescription> extends ElementMatcher.Junction.AbstractBase<T> {
    /**
     ...
     */
    public MethodAnnotationMatcher(ElementMatcher<? super AnnotationList> matcher) {
    ...
    public static <T extends AnnotationSource> Junction<T> byMethodAnnotationMatcher(
        ElementMatcher<? super TypeDescription> matcher) {
        return new MethodAnnotationMatcher(new CollectionItemMatcher<>(annotationType(matcher)));
    }
}
