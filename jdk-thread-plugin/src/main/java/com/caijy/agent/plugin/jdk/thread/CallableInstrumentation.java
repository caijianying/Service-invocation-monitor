 ...
 */
public class CallableInstrumentation extends AbstractClassEnhancePluginDefine {

    private static final String ENHANCE_CLASS = "java.util.concurrent.Callable";
        ...
        return new InstanceMethodsInterceptPoint[]{
                new InstanceMethodsInterceptPoint() {
                    ...
                    public ElementMatcher<MethodDescription> getMethodsMatcher() {
                        return ElementMatchers.named("call").and(takesArguments(0));
                    }
